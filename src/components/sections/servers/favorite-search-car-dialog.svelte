<script lang="ts">
	...
	import FavoriteNewCarSort from '../../shared/favoriteNewCarSort.svelte';
	import FavoriteSortTeirButton from '../../shared/favoriteSortTeirButton.svelte';
