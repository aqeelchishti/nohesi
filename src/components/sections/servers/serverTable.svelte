<script lang="ts">
	...
	import { socialConnecting, user } from '$lib/stores';
	import * as R from 'ramda';
	import { createEventDispatcher } from 'svelte';
	import { _ } from 'svelte-i18n';
	import FilterDialog from '../../shared/filter-dialog.svelte';
	import FilterButton from './filterButton.svelte';
	import Loader from './loader.svelte';
	import SearchCarDialog from './search-car-dialog.svelte';
...
<div class="flex flex-col gap-7">
	{#if width > 950}
		<div class="flex flex-col-reverse gap-2 2xl:flex-row justify-between 2xl:items-center">
	...
	{:else}
		<div class="flex flex-col-reverse gap-2 sm:flex-row justify-between items-start relative">
			<div
