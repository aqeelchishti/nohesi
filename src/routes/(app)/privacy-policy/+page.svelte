...
<div class="px-9 grid grid-cols-6 max-w-screen-3xl mx-auto pt-26 pb-12 font-inter">
	<Button
		title={'Back'}
		icon={'ArrowLeft'}
		size="full"
		classes={'border border-border hover:border-border-light !px-5 uppercase text-content-primary w-max h-max !gap-3'}
		iconClasses={'w-8 sm:w-12 lg:w-auto'}
		on:click={handleClick}
	/>
	<div class="col-span-6 sm:w-4/5 mx-auto lg:col-span-4">
		<div>
			<strong>
				<span>
					<span data-custom-class="title">
						<bdt class="block-component" />
						<h3 class="question">PRIVACY POLICY</h3>
				...
				<strong>
					<span>
						<span data-custom-class="subtitle">
							Last updated
							<bdt class="question">January 25, 2024</bdt>
						</span>
					</span>
				</strong>
			</span>
				...
				<span>
					<span>
						<span data-custom-class="body_text">
							...
							<span>
								<bdt class="question">
									<a href="https://nohesi.gg" target="_blank" data-custom-class="link"
										>https://nohesi.gg</a
									>
								</bdt>
							</span>
			...
			<span>
				<span>
					<span data-custom-class="body_text">
						...
						<bdt class="question">support@nohesi.gg</bdt>
						.
					</span>
				</span>
			</span>
		...
		<div class="flex flex-col gap-2">
			...
			<div>
				<a data-custom-class="link" href="#otherlaws">
					<span>14. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</span>
				</a>
				<span>
					<bdt class="statement-end-if-in-editor">
						<span data-custom-class="body_text" />
			...
			<div>
				<a data-custom-class="link" href="#request">
					<span>17. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span>
				</a>
			</div>
			<div>
				<br />
			...
			<span>
				<span>
					<span data-custom-class="body_text"
						...
						technologies. <bdt class="block-component" />
						<bdt class="block-component" />
					</span>
				</span>
			</span>
				...
				<span>
					<span>
						<span data-custom-class="body_text">
							...
							settings and information about your activity in the Services<span />(such as the
							date/time stamps associated with your usage, pages and files viewed, searches, and
							other actions you take such as which features you use), device event information (such
							as system activity, error reports (sometimes called
							<bdt class="block-component" />"crash dumps"<bdt
								class="statement-end-if-in-editor"
							/>), and hardware settings).<span>
								<span>
									<span data-custom-class="body_text">
										<span>
											<span>
				...
				<span>
					<span>
						<span data-custom-class="body_text">
							...
							accordance with your marketing preferences. You can opt out of our marketing emails at
		...
		<ul>
			<li>
				<span>
					<span data-custom-class="body_text">
						<strong>To deliver targeted advertising to you.</strong> We may process your information
			...
			<li>
				<span data-custom-class="body_text">
					<span>
						...
						efforts to keep our Services safe and secure, including fraud monitoring and prevention.</span
					>
				</span>
				<bdt class="statement-end-if-in-editor">
					<span>
			...
			<li>
				<span data-custom-class="body_text">
					<span>
						...
						Services to better understand how they are being used so we can improve them.</span
					>
				</span>
				<bdt class="statement-end-if-in-editor">
					<span>
		...
		<ul>
			<li>
				<span>
					<span data-custom-class="body_text">
						<strong
							>To determine the effectiveness of our marketing and promotional campaigns.</strong
						>
			...
			<em>
				<span>
					<span data-custom-class="body_text">
						...
						is necessary and we have a valid legal reason (i.e.
						<bdt class="block-component" />
						,
						<bdt class="statement-end-if-in-editor" />
						legal basis) to do so under applicable law, like with your consent, to comply with laws,
		...
		<div>
			<span>
				<span data-custom-class="body_text"
					...
					on the following legal bases to process your personal information:</span
				>
			</span>
		</div>
		<ul>
			...
			<li>
				<span data-custom-class="body_text">
					<span>
						...
						fulfill
						<bdt class="statement-end-if-in-editor" />
						our contractual obligations to you, including providing our Services or at your request prior
			...
			<li>
				<span data-custom-class="body_text">
					<span>
						...
						is reasonably necessary to achieve our legitimate business interests and those interests
						do not outweigh your interests and fundamental rights and freedoms. For example, we may process
						your personal information for some of the purposes described in order to:</span
					>
				</span>
			</li>
		</ul>
		...
		<div>
			<span>
				<span>
					<span data-custom-class="body_text"> <bdt class="block-component" /></span>
				</span></span
			>
		</div>
		<div>
		...
		<div>
			<span>
				<span data-custom-class="body_text"
					>We <bdt class="block-component" />may need to share your personal information in the
			...
			<li>
				<span>
					<span data-custom-class="body_text">
						...
						/>
						or otherwise interact with public areas of the Services, such personal information may be
						viewed by all users and may be publicly made available outside the Services in perpetuity.<bdt
							class="block-component"
						/>
						...
						profile photo, and descriptions of your activity.<bdt
							class="statement-end-if-in-editor"
						/>
						Similarly, other users will be able to view descriptions of your activity, communicate with
						you within our Services, and view your profile.<bdt
							class="statement-end-if-in-editor"
						/>
					</span>
				</span>
		...
		<div>
			<strong>
				<span id="3pwebsites">
					<span data-custom-class="heading_1">5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</span>
				</span>
			</strong>
		</div>
		<div>
		...
		<div>
			<span>
				<span data-custom-class="body_text"
					>The Services<bdt class="block-component" /> may link to third-party websites, online services,
					or mobile applications and/or contain advertisements from third parties that are not affiliated
					...
					endorsement by us. We cannot guarantee the safety and privacy of data you provide to any third
					parties. Any data collected by third parties is not covered by this privacy notice. We are
				...
				<span>
					<span>
						<span>
							<span id="control">
								<strong>
									<span data-custom-class="heading_1">7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</span>
								</strong>
							</span>
						</span>
					</span>
				...
				<span>
					<span data-custom-class="body_text">
						...
						<em
							...
							may have access to certain information about you.</em
						>
					</span>
				</span>
			</span>
			...
			<span>
				<span>
					<span data-custom-class="body_text">
						...
						anonymize
						<bdt class="statement-end-if-in-editor" />
						such information, or, if this is not possible (for example, because your personal information
			...
			<span>
				<span>
					<span data-custom-class="body_text">
						...
						(i) to request access and obtain a copy of your personal information, (ii) to request rectification
						or erasure; (iii) to restrict the processing of your personal information; (iv) if applicable,
						to data portability; and (v) not to be subject to automated decision-making. In certain circumstances,
						you may also have the right to object to the processing of your personal information. You
			...
			<span>
				<span>
					<span data-custom-class="body_text"
						...
						personal information, you also have the right to complain to your <span>
							<span>
								<span data-custom-class="body_text">
									<span>
										<span data-custom-class="body_text">
										...
										<span data-custom-class="body_text">
											<span>
												<a
													...
													rel="noopener noreferrer"
													target="_blank">Federal Data Protection and Information Commissioner</a
												>
											</span>
										</span>
									</span>
		...
		<div>
			<span>
				<span data-custom-class="body_text">
					...
					<strong>
						<u />
					</strong>You can unsubscribe from our marketing and promotional communications at any time
					by
					<bdt class="block-component" />
			...
			<tbody>
					...
					<td>
						<div>
							<span>
								<span>
									<span data-custom-class="body_text">
										<bdt class="block-component" />F<bdt class="else-block" />. Internet or other
								...
								<span>
									<span data-custom-class="body_text"
										>Browsing history, search history, online <bdt
											class="block-component"
										/>behavior<bdt class="statement-end-if-in-editor" />, interest data, and
					...
					<td>
						<div>
							<span>
								<span>
									<span data-custom-class="body_text">
										<bdt class="block-component" />G<bdt class="else-block" />. Geolocation data</span
									>
								</span>
							</span>
						</div>
					...
					<td>
						<div>
							<span>
								<span>
									<span data-custom-class="body_text">
										<bdt class="block-component" />H<bdt class="else-block" />. Audio, electronic,
										visual, thermal, olfactory, or similar information</span
									>
								</span>
							</span>
						</div>
					...
					<td>
						<div>
							<span>
								<span>
									<span data-custom-class="body_text">
										<bdt class="block-component" />I<bdt class="else-block" />. Professional or
					...
					<td>
						<div>
							<span>
								<span>
									<span data-custom-class="body_text">
										<bdt class="block-component" />J<bdt class="else-block" />. Education
										Information</span
									>
								</span>
							</span>
				...
				<tr>
					<td>
						<div>
							<span>
								<span>
									<span data-custom-class="body_text">
										<bdt class="block-component" />K<bdt class="else-block" />. Inferences drawn
										from collected personal information</span
									>
								</span>
							</span>
						</div>
					...
					<td>
						...
						<div data-custom-class="body_text">
							<span data-custom-class="body_text">
								<bdt class="block-component" />NO<span>
									<span>
										<span data-custom-class="body_text">
											<span>
												<span data-custom-class="body_text">
				...
				<tr>
					<td>
						<span data-custom-class="body_text">
							<bdt class="block-component" />L<bdt class="else-block" />. Sensitive personal
							Information</span
						>
					</td>
					<td>
		...
		<div>
			...
			<span data-custom-class="body_text"
				...
				or for:<bdt class="block-component" />
			</span>
		</div>
		<ul>
			<li>
				<span data-custom-class="body_text"
					>Category A - <bdt class="question">As long as the user has an account with us</bdt>
					<bdt class="statement-end-if-in-editor" />
				</span>
			</li>
		</ul>
		...
		<ul>
			<li>
				<span data-custom-class="body_text"
					>Category B - <bdt class="question">As long as the user has an account with us</bdt>
					<bdt class="statement-end-if-in-editor" />
				</span>
			</li>
		</ul>
		...
		<div>
				...
				<span>
					<span>
						<span data-custom-class="body_text"
							...
							disclose personal information to in the section, <bdt class="block-component" />"<bdt
								class="statement-end-if-in-editor"
							/>
						</span>
					</span>
				...
				<span>
					<span>
						<span data-custom-class="body_text"
							...
							not considered to be <bdt class="block-component" />"selling"<bdt
								class="statement-end-if-in-editor"
							/>
				...
				<span>
					<span>
						<span data-custom-class="body_text"
							...
							a business or commercial purpose in the preceding twelve (12) months. We<span />will
			...
			<div>
				<strong>
					<span data-custom-class="heading_2">California Residents</span>
				</strong>
			</div>
			<div>
				<br />
			...
			<div>
				<span data-custom-class="body_text"
					>California Civil Code Section 1798.83, also known as the <bdt
						class="block-component"
					/>"Shine The Light"<bdt class="statement-end-if-in-editor" /> law permits our users who are
					...
					information in the immediately preceding calendar year. If you are a California resident and
			...
			<div>
				<span data-custom-class="body_text"
					...
					completely or comprehensively removed from all our systems (e.g.<bdt
						class="block-component"
					/>,<bdt class="statement-end-if-in-editor" /> backups, etc.).</span
				>
			</div>
			<div>
				<span>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						Privacy Act (CCPA), you have the rights listed below.</span
					>
				</span>
			</div>
			<div>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						>The California Code of Regulations defines a <bdt
							class="block-component"
						/>"residents"<bdt class="statement-end-if-in-editor" /> as:</span
					>
				</span>
			</div>
			<div>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						State of California for a temporary or transitory purpose</span
					>
				</span>
			</div>
			<div>
				...
				<span>
					<span data-custom-class="body_text"
						>All other individuals are defined as <bdt
							class="block-component"
						/>"non-residents."<bdt class="statement-end-if-in-editor" />
					</span>
				</span>
			</div>
			<div>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						>If this definition of <bdt class="block-component" />"resident"<bdt
							class="statement-end-if-in-editor"
				...
				<span>
					<span>
						<span data-custom-class="body_text"
							...
							be required to protect against illegal activities.</span
						>
					</span>
				</span>
			</div>
			...
			<div>
				<span>
					<span>
						<span data-custom-class="body_text"
							>Depending on the circumstances, you have a right to know:<span>
								<span>
									<span data-custom-class="body_text">
										<span>
											<span>
			...
			<ul>
				<li>
					<span>
						<span>
							<span data-custom-class="body_text"
								>whether we collect and use your personal information;<span>
									<span>
										<span data-custom-class="body_text">
											<span>
												<span>
			...
			<ul>
				<li>
					<span>
						<span>
							<span data-custom-class="body_text"
								>the categories of personal information that we collect;<span>
									<span>
										<span data-custom-class="body_text">
											<span>
												<span>
			...
			<ul>
				<li>
					<span>
						<span>
							<span data-custom-class="body_text"
								>the purposes for which the collected personal information is used;<span>
									<span>
										<span data-custom-class="body_text">
											<span>
												<span>
			...
			<ul>
				<li>
					<span>
						<span>
							<span data-custom-class="body_text"
								>whether we sell or share personal information to third parties;<span>
									<span>
										<span data-custom-class="body_text">
											<span>
												<span>
			...
			<ul>
				<li>
					<span data-custom-class="body_text"
						>the specific pieces of personal information we collected about you.<bdt
							class="statement-end-if-in-editor"
						/>
					</span>
				</li>
				...
				<span>
					<span>
						<span data-custom-class="body_text"
							...
							individual data to verify a consumer request.</span
						>
					</span>
				</span>
			</div>
				...
				<span>
					<span>
						<span data-custom-class="body_text"
							...
							we may contact you through a communication method (e.g.<bdt
								class="block-component"
							/>,<bdt class="statement-end-if-in-editor" /> phone or email) that you have previously
							provided to us. We may also use other verification methods as the circumstances dictate.</span
						>
					</span>
				</span>
			</div>
				...
				<span>
					<span>
						<span data-custom-class="body_text"
							...
							requesting additional information from you for the purposes of verification. However,
							if we cannot verify your identity from the information already maintained by us, we
					...
					<span>
						<span>
							<span data-custom-class="body_text"
								...
								relevant, or ask to restrict the processing of the information.<span>
									<span>
										<span data-custom-class="body_text">
											<span>
												<span>
			...
			<ul>
				<li>
					<span>
						<span>
							<span data-custom-class="body_text"
								>You can designate an <bdt class="block-component" />authorized<bdt
									class="statement-end-if-in-editor"
								/>
								agent to make a request under the CCPA on your behalf. We may deny a request from an
								<bdt class="block-component" />authorized<bdt class="statement-end-if-in-editor" />
								agent that does not submit proof that they have been validly
								<bdt class="block-component" />authorized<bdt class="statement-end-if-in-editor" />
								to act on your behalf in accordance with the CCPA.<span>
									<span>
										<span data-custom-class="body_text">
											<span>
												<span>
					...
					<span>
						<span>
							<span data-custom-class="body_text"
								...
								the date of the request submission.<span>
									<span>
										<span data-custom-class="body_text">
											<span>
												<span>
			...
			<div>
				<span>
					<span>
						<span data-custom-class="body_text"
							>To exercise these rights, you can contact us <bdt class="block-component" />by
							visiting
							<span>
								<bdt class="question">support@nohesi.gg</bdt>
							</span>, <bdt class="else-block" />
						</span>
						<span>
							<span data-custom-class="body_text">
								<span>
									<span data-custom-class="body_text">
										<bdt class="block-component" />by email at
										<bdt class="question">support@nohesi.gg</bdt>,
										<bdt class="statement-end-if-in-editor" />
										<bdt class="block-component" />by calling toll-free at
										<bdt class="question">‪(805) 222-0218‬</bdt>,
										<span>
											<span data-custom-class="body_text">
												<span>
													<span data-custom-class="body_text">
				...
				<span data-custom-class="body_text"
					...
					complaint about how we handle your data, we would like to hear from you.</span
				>
				<span>
					<span data-custom-class="body_text">
						<bdt class="block-component">
			...
			<div>
				<span>
					<strong>
						<span data-custom-class="heading_2">Colorado Residents</span>
					</strong>
				</span>
			</div>
			<div>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						cases, we may decline your request as permitted by law.</span
					>
					<bdt class="block-component" />
				</span>
			</div>
				...
				<li>
					<span>
						<span data-custom-class="body_text"
							...
							produce legal or similarly significant effects (<bdt
								class="block-component"
							/>"profiling"<bdt class="statement-end-if-in-editor" />)</span
						>
					</span>
					<bdt class="statement-end-if-in-editor" />
				</li>
			...
			<div data-custom-class="body_text">
				...
				<span>these</span>
				<bdt class="statement-end-if-in-editor" />
				<span>rights described above, please <bdt class="block-component" />email</span>
				<bdt class="question">support@nohesi.gg</bdt>
				<span> or </span>
				<bdt class="block-component" />
				<span>visit</span>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						decision, please email us at <bdt class="block-component" />
						<bdt class="question">support@nohesi.gg</bdt>
						<bdt class="else-block" />. Within forty-five (45) days of receipt of an appeal, we will
						inform you in writing of any action taken or not taken in response to the appeal,
						including a written explanation of the reasons for the decisions.</span
					>
					<bdt class="statement-end-if-in-editor" />
				</span>
			</div>
			...
			<div>
				<strong>
					<span>
						<span data-custom-class="heading_2">Connecticut Residents</span>
					</span>
				</strong>
			</div>
			<div>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						and in certain cases, we may decline your request as permitted by law.</span
					>
					<bdt class="block-component" />
				</span>
			</div>
			...
			<div data-custom-class="body_text">
				<bdt class="block-component"> <span /></bdt>To submit a request to exercise
				<bdt class="block-component" />these<bdt class="statement-end-if-in-editor" />
				rights described above, please <bdt class="block-component" />email
				<bdt class="question">support@nohesi.gg</bdt>
				or <bdt class="block-component" />visit
				<span>
					<bdt class="question">support@nohesi.gg</bdt>
				</span>
				<bdt class="else-block" />.
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						decision, please email us at <bdt class="block-component" />
						<bdt class="question">support@nohesi.gg</bdt>
						<bdt class="else-block" />. Within sixty (60) days of receipt of an appeal, we will
						inform you in writing of any action taken or not taken in response to the appeal,
						including a written explanation of the reasons for the decisions.</span
					>
				</span>
			...
			<div>
				<span>
					<strong>
						<span data-custom-class="heading_2">Utah Residents</span>
					</strong>
				</span>
			</div>
			<div>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						(UCPA), you have the rights listed below. However, these rights are not absolute, and in
						certain cases, we may decline your request as permitted by law.</span
					>
					<bdt class="block-component" />
				</span>
			</div>
			...
			<ul>
				<li>
					<span>
						<span data-custom-class="body_text"
							>Right to opt out of the processing of your personal data if it is used for targeted
							advertising or the sale of personal data</span
						>
						<bdt class="statement-end-if-in-editor" />
					</span>
				</li>
			...
			<div data-custom-class="body_text">
				<span>
					<bdt class="block-component"> <span data-custom-class="body_text" /></bdt>To submit a
					request to exercise <bdt class="block-component" />these<bdt
						class="statement-end-if-in-editor"
					/>
					rights described above, please <bdt class="block-component" />email
					<bdt class="question">support@nohesi.gg</bdt>
			...
			<div>
				<span>
					<strong>
						<span data-custom-class="heading_2">Virginia Residents</span>
					</strong>
				</span>
			</div>
			<div>
			...
			<div data-custom-class="body_text">
				<span>
					<bdt class="block-component"> <span data-custom-class="body_text" /></bdt>"Consumer"<bdt
						class="statement-end-if-in-editor"
			...
			<div data-custom-class="body_text">
				<span>
					<bdt class="block-component"> <span data-custom-class="body_text" /></bdt>"Personal data"<bdt
						class="statement-end-if-in-editor"
					/>
					means any information that is linked or reasonably linkable to an identified or identifiable
					natural person. <bdt class="block-component" />"Personal data"<bdt
						class="statement-end-if-in-editor"
			...
			<div data-custom-class="body_text">
				<span>
					<bdt class="block-component"> <span data-custom-class="body_text" /></bdt>"Sale of
					personal data"<bdt class="statement-end-if-in-editor" /> means the exchange of personal data
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						>If this definition of <bdt class="block-component" />"consumer"<bdt
							class="statement-end-if-in-editor"
						/> applies to you, we must adhere to certain rights and obligations regarding your personal
						data.</span
					>
			...
			<div>
				<span>
					<bdt class="block-component" />
					<span data-custom-class="body_text"
						>You may <bdt class="block-component" />contact us by email at
						<bdt class="question">support@nohesi.gg</bdt>
						or <bdt class="block-component" />visit
						<span>
							<bdt class="question">support@nohesi.gg</bdt>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						>If you are using an <bdt class="block-component" />authorized<bdt
							class="statement-end-if-in-editor"
						/>
						agent to exercise your rights, we may deny a request if the
						<bdt class="block-component" />authorized<bdt class="statement-end-if-in-editor" />
						agent does not submit proof that they have been validly
						<bdt class="block-component" />authorized<bdt class="statement-end-if-in-editor" /> to act
						on your behalf.</span
					>
				</span>
			</div>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						you and your consumer's request. If you submit the request through an <bdt
							class="block-component"
						/>authorized<bdt class="statement-end-if-in-editor" /> agent, we may need to collect additional
						information to verify your identity before processing your request.</span
					>
				</span>
			</div>
			<div>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						and reasoning behind it. If you wish to appeal our decision, please email us at <bdt
							class="block-component"
						/>
						<bdt class="question">support@nohesi.gg</bdt>
						<bdt class="else-block" />. Within sixty (60) days of receipt of an appeal, we will
			...
			<div>
				<span>
					...
					<span data-custom-class="heading_2">
						...
						<bdt class="statement-end-if-in-editor" />
						<bdt class="block-component" /> <strong>and</strong>
						<bdt class="statement-end-if-in-editor" />
						<bdt class="block-component" />
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						set by <bdt class="block-component" />Australia's Privacy Act 1988<bdt
							class="statement-end-if-in-editor"
						/>
						<bdt class="block-component" /> and <bdt class="statement-end-if-in-editor" />
						<bdt class="block-component" />New Zealand's Privacy Act 2020<bdt
							class="statement-end-if-in-editor"
						/> (Privacy Act).</span
					>
				</span>
				...
				<span>
					<span data-custom-class="body_text"
						>This privacy notice satisfies the notice requirements defined in<bdt
							class="block-component"
						/>
						both Privacy Acts<bdt class="block-component" />, in particular: what personal
						information we collect from you, from which sources, for which purposes, and other
						recipients of your personal information.</span
					>
				</span>
			</div>
			<div>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						applicable purpose, it may affect our ability to provide our services, in particular:</span
					>
				</span>
			</div>
			<div>
			...
			<div>
				<span>
					<span data-custom-class="body_text"
						...
						provided in the section <bdt class="block-component" />"<bdt
							class="statement-end-if-in-editor"
						/>
						<a data-custom-class="link" href="#request">
							<span>
								<span data-custom-class="link"
									>HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span
								>
							</span>
						</a>
						<bdt class="block-component" />"</span
			...
			<div>
				<span
					>I<span data-custom-class="body_text"
						>f you believe we are unlawfully processing your personal information, you have the
						right to submit a complaint about <bdt class="block-component" />a breach of the
						...
						<bdt class="statement-end-if-in-editor" />
						<bdt class="block-component" /> and <bdt class="statement-end-if-in-editor" />
						<bdt class="block-component" />a breach of New Zealand's Privacy Principles to the
						<a
							data-custom-class="link"
						...
						>
							<span>
								<span data-custom-class="link">Office of New Zealand Privacy Commissioner</span>
							</span>
						</a>
			...
			<div>
				...
				>
					<span>
						<span data-custom-class="body_text">
							<span data-custom-class="link">The Information Regulator (South Africa)</span>
						</span>
					</span>
				</a>
			</div>
			...
			<div>
				<span data-custom-class="body_text">
					...
					>
						<span>
							<span data-custom-class="link">PAIAComplaints@inforegulator.org.za</span>
						</span>
					</a>
					<span> & </span>
				</span>
				...
				>
					<span>
						<span data-custom-class="body_text">
							<span data-custom-class="link">POPIAComplaints@inforegulator.org.za</span>
						</span>
					</span>
				</a>
				<span>
				...
				<span>
					<span>
						<span data-custom-class="body_text"
							...
							indicated by an updated <bdt class="block-component" />"Revised"<bdt
								class="statement-end-if-in-editor"
							...
							review this privacy notice frequently to be informed of how we are protecting your information.</span
						>
					</span>
				</span>
			</div>
						...
						<span data-custom-class="body_text"
							>If you have questions or comments about this notice, you may <span>
								<span data-custom-class="body_text">
									<bdt class="block-component">
										<bdt class="block-component" />
									</bdt>email us at <bdt class="question">support@nohesi.gg or </bdt>
									<bdt class="statement-end-if-in-editor">
										<bdt class="block-component" />
									</bdt>
								</span>
						...
						<span data-custom-class="body_text">
							<span>
								<span>
									<span>
										<span data-custom-class="body_text">
											<bdt class="question">No Hesi LLC</bdt>
										</span>
									</span>
								</span>
							</span>
			...
			<div>
				<span>
					<span data-custom-class="body_text">
						<bdt class="question">9637 Via Rimini</bdt>
						<span>
							<span>
								<bdt class="block-component" />
							</span>
			...
			<div>
				<span>
					<span data-custom-class="body_text">
						<bdt class="question">Burbank</bdt>
						<span>
							<span>
								<bdt class="block-component" />
								<bdt class="block-component" />, <bdt class="question">CA</bdt>
								<bdt class="statement-end-if-in-editor" />
								<bdt class="block-component" />
								<bdt class="block-component" /> <bdt class="question">91504-1401</bdt>
								<bdt class="statement-end-if-in-editor" />
								<bdt class="block-component" />
								<bdt class="block-component" />
								<bdt class="block-component" />
			...
			<div>
				<span>
					<span>
						<span data-custom-class="body_text">
							<bdt class="block-component" />Based on the applicable laws of your country, you may
							have the right to request access to the personal information we collect from you,
							change that information, or delete it.
							<bdt class="else-block">
								<bdt class="block-component" />To request to review, update, or delete your personal
...
<style lang="postcss">
	...
	div > p {
		@apply text-content-secondary mt-6;
	}
	p,
	span,
	div {
	...
	li {
		@apply text-content-secondary my-2;
	}
	li > p {
		@apply my-3;
	}
	.block-text {
		@apply !text-content-primary font-medium pl-5 border-l-4 border-primary-violete-light;
	}
	a, a span {
		@apply underline text-primary-violete hover:text-primary-violete-light;
	}
	table,
	td {
		@apply border border-content-tertiary;
	}
