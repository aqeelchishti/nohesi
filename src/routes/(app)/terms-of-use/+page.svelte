...
<div class="px-9 grid grid-cols-6 max-w-screen-3xl mx-auto pt-26 pb-12 font-inter">
	...
	<div class="col-span-6 sm:w-4/5 mx-auto lg:col-span-4">
		...
		<p><strong>Last updated: 2024-01-24</strong></p>
		<p>1. <b>Introduction</b></p>
		<p>Welcome to <b>No Hesi LLC</b> (“Company”, “we”, “our”, “us”)!</p>
		<p>
			These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at <b
				><a href="https://nohesi.gg">https://nohesi.gg</a></b
			>
			(together or individually “Service”) operated by <b>No Hesi LLC</b>.
		</p>
		<p>
		...
		<p>
			...
			but please let us know by emailing at <b>support@nohesi.gg</b> so we can try to find a solution.
		...
		<p>
			...
			set depending on the type of subscription plan you select when purchasing a Subscription.
		</p>
		<p>
			At the end of each Billing Cycle, your Subscription will automatically renew under the exact
			same conditions unless you cancel it or No Hesi LLC cancels it. You may cancel your
			Subscription renewal either through your online account management page or by contacting
			support@nohesi.gg customer support team.
		</p>
		<p>
			A valid payment method is required to process the payment for your subscription. You shall
			provide No Hesi LLC with accurate and complete billing information that may include but not
			...
			authorize No Hesi LLC to charge all Subscription fees incurred through your account to any
			such payment instruments.
		</p>
		<p>
			Should automatic billing fail to occur for any reason, No Hesi LLC reserves the right to
			terminate your access to the Service with immediate effect.
		</p>
		<p>6. <b>Free Trial</b></p>
		<p>
			No Hesi LLC may, at its sole discretion, offer a Subscription with a free trial for a limited
		...
		<p>
			...
			charged by No Hesi LLC until Free Trial has expired. On the last day of Free Trial period,
		...
		<p>
			At any time and without notice, No Hesi LLC reserves the right to (i) modify Terms of Service
			of Free Trial offer, or (ii) cancel such Free Trial offer.
		</p>
		<p>7. <b>Fee Changes</b></p>
		<p>
			No Hesi LLC, in its sole discretion and at any time, may modify Subscription fees for the
			Subscriptions. Any Subscription fee change will become effective at the end of the
			then-current Billing Cycle.
		</p>
		<p>
			No Hesi LLC will provide you with a reasonable prior notice of any change in Subscription fees
		...
		<p>
			No Hesi LLC has the right but not the obligation to monitor and edit all Content provided by
			users.
		</p>
		<p>
			In addition, Content found on or through this Service are the property of No Hesi LLC or used
		...
		<p>
			...
			functionality are and will remain the exclusive property of No Hesi LLC and its licensors.
		...
		<p>
			...
			submit your claim via email to support@nohesi.gg, with the subject line: “Copyright
		...
		<p>You can contact our Copyright Agent via email at support@nohesi.gg.</p>
		<p>17. <b>Error Reporting and Feedback</b></p>
		<p>
			You may provide us either directly at support@nohesi.gg or via third party sites and tools
		...
		<p>
			...
			controlled by No Hesi LLC.
		</p>
		<p>
			No Hesi LLC has no control over, and assumes no responsibility for the content, privacy
		...
		<p>
			These Terms shall be governed and construed in accordance with the laws of California, which
		...
		<p style="margin-top: 5em; font-size: 0.7em;">
			...
			for <b>https://nohesi.gg</b> by <a href="https://policymaker.io">PolicyMaker.io</a> on 2024-01-24.
		</p>
	</div>
</div>
